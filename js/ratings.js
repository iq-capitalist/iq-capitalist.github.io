...
function displayRatings(ratings) {
    ...
    html += `
        ...
        <p class="winnings-note">🚀 - игрок использует бустеры.<br>* - потенциальный выигрыш по состоянию на момент расчёта рейтинга. Окончательный выигрыш может быть другим.</p>
    `;
