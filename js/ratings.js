...
function updateLastUpdate(lastUpdate) {
    ...
    if (lastUpdateElement) {
        lastUpdateElement.innerHTML = `Данные обновлены: ${lastUpdate}`;
    } else {
...
function displayRatings(ratings) {
    ...
    html += `
        ...
        <p class="winnings-note">🚀 - игрок использует бустеры.<br>* - потенциальный выигрыш по состоянию на момент расчёта таблицы. Окончательный выигрыш может быть другим.</p>
    `;
